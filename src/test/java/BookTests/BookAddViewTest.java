...
public class BookAddViewTest {
    ...
    @Test
    public void BookAddView_WhenCorrectDataEntered_ReturnsLibrarianView() {
        assertThat(bookResource.AddBook("Test", "Aoife", "Finnegan", "1234567890", "978-1234567890*"), is(instanceOf(LibrarianView.class)));
    }
